...
/** Lead-capture form for comparison/guide pages — topic prefilled, photo/video upload, and attribution tracking fields. */
  ...
  return (
    <div id="quote" className="rounded-3xl border border-border/70 bg-surface-elevated p-6 elevate-elevated sm:p-8">
      ...
      <form ref={formRef} action={formAction} className="mt-6 space-y-5">
        <input type="hidden" name="service" value={topicLabel} />
        <input type="hidden" name="landingPage" value={pathname ?? ""} />
        <input type="hidden" name="pageType" value="comparison" />
        ...
        <div className="grid gap-2">
          <Label htmlFor="quote-topic">Topic</Label>
          <Input id="quote-topic" value={topicLabel} readOnly disabled />
        </div>
        ...
        <div className="grid gap-2">
          <Label htmlFor="quote-notes">Tell us about your garage (optional)</Label>
        ...
        <div className="grid gap-2">
          ...
          <input
            ...
            type="file"
            accept="image/*,video/*"
            aria-label="Upload a photo or video of your garage"
            title="Upload a photo or video of your garage"

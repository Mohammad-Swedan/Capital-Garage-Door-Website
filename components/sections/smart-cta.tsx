      ...
      <Container className="relative z-10">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-8">
          ...
          <Reveal className="flex flex-col items-start gap-4 sm:gap-6">
            ...
            <p className="max-w-xl text-base text-primary-foreground/80 sm:text-lg lg:text-xl">
          ...
          <Reveal delay={0.15} className="grid gap-3 sm:grid-cols-2 sm:gap-4 lg:gap-6">
            {/* Card 1: Booking */}
            <button
              type="button"
              onClick={() => setBookingOpen(true)}
              className="group relative flex cursor-pointer flex-col items-start justify-between gap-4 overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 text-left shadow-[0_8px_32px_rgba(0,0,0,0.12)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:border-cta/40 hover:bg-white/10 hover:shadow-[0_8px_32px_rgba(200,34,42,0.2)] active:scale-[0.98] sm:gap-6 sm:rounded-3xl sm:p-8"
            >
            ...
            <button
              ...
              className="group relative flex cursor-pointer flex-col items-start justify-between gap-4 overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 text-left shadow-[0_8px_32px_rgba(0,0,0,0.12)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:border-[#0f4e9b]/40 hover:bg-white/10 hover:shadow-[0_8px_32px_rgba(15,78,155,0.2)] active:scale-[0.98] sm:gap-6 sm:rounded-3xl sm:p-8"
            >

...
export const bossGarageDoorMotorsPerth: BrandPage = {
  ...
  intro: {
    ...
    paragraphs: [
      ...
      "We repair Boss openers whenever the fault is a part rather than the drive itself — most calls end there, with a technician arriving already carrying the common parts on the van. Where a unit has genuinely reached the end of its working life and parts are getting hard to source, we'll say so plainly rather than chase a diagnosis that won't hold. As a Boss dealer we supply, install, service and repair the sectional, panel-tilt, roller and gate openers the brand covers, so a replacement comes with a new motor, coded remotes and a workmanship warranty, fitted in a single visit.",
    ],
  },
  services: [
    {
